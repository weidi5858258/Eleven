...
public class SearchActivity extends FragmentActivity implements
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        if (!TextUtils.isEmpty(mFilterString)) {
            ...
            Class searchManagerClass = SearchManager.class;
            String SEARCH_MODE = "";
            if(searchManagerClass != null){
                try {
                    Field field = searchManagerClass.getDeclaredField("SEARCH_MODE");
                    field.setAccessible(true);
                    SEARCH_MODE = (String)field.get(searchManagerClass);
    ...
    public void setLoading() {
        if (mCurrentState != VisibleState.Loading) {
            Class mHandlerClass = mHandler.getClass();
            boolean hasCallbacks = false;
            if(mHandlerClass != null){
                try {
                    Method method = mHandlerClass.getDeclaredMethod("hasCallbacks", Runnable.class);
                    method.setAccessible(true);
                    hasCallbacks = (Boolean) method.invoke(mHandler, mLoadingRunnable);
